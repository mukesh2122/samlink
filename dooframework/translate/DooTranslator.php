...
class DooTranslator {
	...
	*/
	...
	private $_supportedAdapters = array("csv", "gettext", "array", "ini", "database");
	...
	*/
	...
	private function _loadData($data) {
		...
		switch ($this->_adapter) {
			...
			case 'database':
				$A2 = strtoupper($data);
				$query = "SELECT TransKey,TransText$A2 as TransText FROM ge_screentexts WHERE TransText$A2 <>''";
