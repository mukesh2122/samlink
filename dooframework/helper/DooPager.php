...
.inactivePrev, .inactiveNext{
    ...
    public function paginate($page, $itemPerPage=0){
        ...
        // changed the order of these 2 lines, as suggested fix for 0 items on page by Marcio Rodrigues 
        if($this->currentPage > $this->totalPage) { $this->currentPage = $this->totalPage; };
        if($this->currentPage < 1 || !is_numeric($this->currentPage)) { $this->currentPage = 1; };
