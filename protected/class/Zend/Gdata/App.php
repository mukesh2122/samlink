 ...
 * Zend_Gdata_Feed
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Http/Client.php';
 ...
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
        ...
        $applicationId = 'MyCompany-MyApp-1.0')
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/HttpException.php';
    ...
    {
        require_once Doo::conf()->CLASS_PATH.'Zend/Http/Client/Exception.php';
        ...
        require_once Doo::conf()->CLASS_PATH.'Zend/Uri/Http.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/HttpAdapterStreamingSocket.php';
        ...
        $minorProtocolVersion = null)
    {
        if (!class_exists($className, false)) {
          require_once Doo::conf()->CLASS_PATH.'Zend/Loader.php';
        ...
        if (!$success) {
            require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Exception.php';
