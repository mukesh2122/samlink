 ...
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Entry.php';
 ...
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Generator.php';

/**
 * @see Zend_Gdata_App_Extension_Icon
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Icon.php';

/**
 * @see Zend_Gdata_App_Extension_Logo
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Logo.php';

/**
 * @see Zend_Gdata_App_Extension_Subtitle
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Subtitle.php';
