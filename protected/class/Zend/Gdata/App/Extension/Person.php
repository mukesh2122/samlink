 ...
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension.php';

/**
 * @see Zend_Gdata_App_Extension_Name
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Name.php';

/**
 * @see Zend_Gdata_App_Extension_Email
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Email.php';

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Uri.php';
