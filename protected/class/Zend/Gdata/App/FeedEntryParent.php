...
*/
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Author.php';

/**
 * @see Zend_Gdata_App_Extension_Category
*/
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Category.php';

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/App/Extension/Updated.php';

/**
 * Zend_Version
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Version.php';
...
abstract class Zend_Gdata_App_FeedEntryParent extends Zend_Gdata_App_Base
{
    ...
    public function setMajorProtocolVersion($value)
    {
        if (!($value >= 1) && ($value !== null)) {
            require_once(Doo::conf()->CLASS_PATH.'Zend/Gdata/App/InvalidArgumentException.php');
