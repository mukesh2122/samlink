 ...
 * @see Zend_Gdata
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata.php';
 ...
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/Entry.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchTotalResults
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Gdata/Extension/OpenSearchItemsPerPage.php';
    ...
    protected function takeAttributeFromDOM($attribute)
    {
        ...
        case 'etag':
            ...
            elseif ($this->_etag != $etag) {
                require_once(Doo::conf()->CLASS_PATH.'Zend/Gdata/App/IOException.php');
