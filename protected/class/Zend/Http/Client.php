 ...
 * @see Zend_Uri
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Uri.php';


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once Doo::conf()->CLASS_PATH.'Zend/Http/Response/Stream.php';
