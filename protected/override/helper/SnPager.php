 ...
 * @since 1.0
 */
class SnPager extends DooPager{
    /**
...
.inactivePrev, .inactiveNext{
    ...
    public function paginate($page, $itemPerPage=0){
        ...
        if($this->_noNextPrev)
            $this->components['prev_link'] = ($this->currentPage != 1) ? "<li><a class=\"{$this->prevCss}\" href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a></li>":"<li><a href=\"javascript:void(0);\" class=\"{$this->inactivePrevCss}\">{$this->prevText}</a></li>";
        else
            $this->output = ($this->currentPage != 1) ? "<li><a class=\"{$this->prevCss}\" href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a></li>":"<li><a href=\"javascript:void(0);\" class=\"{$this->inactivePrevCss}\">{$this->prevText}</a></li>";
        ...
        if($this->totalPage > $this->maxLength){
            ...
            if($this->_noNextPrev)
                $this->components['next_link'] = ($this->currentPage != $this->totalPage) ? "<li><a class=\"{$this->nextCss}\" href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a></li>\n" : "<li><a href=\"javascript:void(0);\" class=\"{$this->inactiveNextCss}\">{$this->nextText}</a></li>\n";
            else
                $this->output .= ($this->currentPage != $this->totalPage) ? "<li><a class=\"{$this->nextCss}\" href=\"{$this->baseUrl}/$next_page\">{$this->nextText}</a></li>\n" : "<li><a href=\"javascript:void(0);\" class=\"{$this->inactiveNextCss}\">{$this->nextText}</a></li>\n";
        }
        else{
            for($i=1;$i<=$this->totalPage;$i++){
