...
<?php endif; ?>
	...
	<form class="standard_form mt30 stand_form_login" method="get" id="login_form_page">
		...
		<div class="standard_form_elements clearfix">
			<div class="standard_form_info_header">
				<h2><?php echo $this->__('Please sign in'); ?></h2>
				<p><?php echo $this->__("You need to sign in to access this area. If you don't have an account you can register [_1]right here[_2].", array('<a href="'.MainHelper::site_url('registration').'">', '</a>')); ?></p>
			</div>
