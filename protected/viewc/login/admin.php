...
<?php endif; ?>
	...
	<form class="standard_form stand_form_login mt30" method="get" id="login_form_page">
		<h1 class="standard_form_header"><?php echo $this->__('Sign in as admin'); ?></h1>
		...
		<?php if(1 == 2): // WTF ???? - how does this makes sense ??? ?>
