...
<div id="pn_tournaments_list">
        <span class="tournament_top"><?php echo $title; ?></span>
        <ul class="tournament_list">
                ...
                foreach ($tournamentsList as $tournament): 
                        ...
                        $isSignedUp = $esport->isTeamSignedUp(User::getUser()->ID_TEAM,$tournament['ID_LEAGUE']);
                ...
                ?>
                        <li class="<?php echo $background_url; ?>">
                                ...
                                <div id="<?php echo $isSignedUp; ?>" class="tournament_buttons">
                                    ...
                                    <?php endif; ?>
                                        <a class="button red" href="<?php echo MainHelper::site_url('esport/tournamentinfo/'.$tournament['ID_LEAGUE']); ?>"><?php echo $this->__('Information'); ?></a>
                                </div>
                        </li>
                <?php endforeach; ?>
        </ul>
