		...
		<div class="esports_content">
			...
			<?php 
                        if($playmode == ESPORT_PLAYMODE_PLAY4CREDITS)
                            echo $this->renderBlock('esport/createchallenge/play4credits', array('profile'=>$profile)); 
                        else
                            echo $this->renderBlock('esport/createchallenge/play4free', array('profile'=>$profile)); 
                        ?>
		</div>
