		...
		<div class="esports_content">
			<?php echo $this->renderBlock('esport/common/leftcolumn', array('profile'=>$profile,'choosegameEnabled'=>false,'bettingladderEnabled'=>false)); ?>		
                        ...
                        if($playmode == ESPORT_PLAYMODE_PLAY4CREDITS)
                            echo $this->renderBlock('esport/createchallenge/verify/play4credits', array('profile'=>$profile, 'gamedata'=>$gamedata)); 
                        else
                            echo $this->renderBlock('esport/createchallenge/verify/play4free', array('profile'=>$profile, 'gamedata'=>$gamedata)); 
                        ?>
		</div>
