        ...
        <div class="browsed_list">
        	<div class="challenge">
                    <div class="browse_content game">
                        <a href="#go_to_game_page"><img src="#game_image" /></a>
                        <h2><a href="#go_to_game_page">Counter-Strike: Global Offensive Counter Force</a></h2>
                    </div>
                    <div class="browse_content versus">
                        <a href="#go_to_team_page"><img src="#team_image" /></a>
                        <h2><a href="#go_to_team_page">Copenhagen Wolves Wannabe Long Clan Name Nghe</a></h2>
                    </div>
                <div class="browse_content type">
                    <p>PLAY4FREE</p><p>Unranked</p>
                </div>
                <div class="browse_content status">
                    <a class="button button_small grey pull_left btn_red_gradient_bg" href="#">Accept</a>
                    <a class="button button_small grey pull_left btn_grey_gradient_bg" href="#">Decline</a>
                </div>
        	</div>
            <div class="challenge">
                    <div class="browse_content game">
                        <a href="#go_to_game_page"><img src="#game_image" /></a>
                        <h2><a href="#go_to_game_page">Counter-Strike: Source</a></h2>
                    </div>
                    <div class="browse_content versus">
                        <a href="#go_to_team_page"><img src="#team_image" /></a>
                        <h2><a href="#go_to_team_page">Copenhagen Wolves</a></h2>
                    </div>
                <div class="browse_content type">
                    <p>PLAY4FREE</p><p>Unranked</p>
                </div>
