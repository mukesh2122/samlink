...
<div class="esports_right_column team_center">
	...
	<div class="overview red_gradient_bg">
            <h2><?php echo strtoupper('Browse teams'); ?><span class="header_small_font"><?php echo $this->__('By alphabet').' '; ?>(
                    <?php foreach($alphabet as $letter): ?>
                        <a href="<?php echo MainHelper::site_url('esport/browseteams/'.$letter); ?>"><?php echo strtoupper($letter); ?></a>
                    <?php endforeach; ?>
            )</span></h2>
    </div>
    <div class="grey_bg_margin">
    	<div class="search_for_team">
            <div class="news esport_profile_boxheaders live_streams mt0">
                <p><?php echo strtoupper($this->__('Search')).' '; ?><span><?php echo strtoupper($this->__('Team')); ?></span></p>
            </div>
        ...
        <div class="browsed_list">
            ...
            <div class="result_single_team">
                <div class="browse_content teams">
                    <a href="<?php echo MainHelper::site_url('esport/team/'.$team->ID_TEAM); ?>"><?php echo MainHelper::showImage($team, THUMB_LIST_60x60, false, array('width', 'no_img' => 'noimage/no_player_60x60.png'));?></a>
                    <h2><a href="<?php echo MainHelper::site_url('esport/team/'.$team->ID_TEAM); ?>"><?php echo $team->DisplayName ?></a></h2>
                </div>
                <div class="browse_content games">
                    <div class="images_holder">
                        <?php foreach($games as $game): ?>
                        <?php echo MainHelper::showImage($games, THUMB_LIST_18x18, false, array('width', 'no_img' => 'noimage/no_game_18x18.png', 'title' => $game->GameName));?>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="error_message">
                    <h1><?php echo $this->__('No teams were found'); ?></h1>
                </div>
            <?php endif; ?>
        </div>
    </div>
