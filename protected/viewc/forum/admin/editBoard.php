<div class="message_container">
    ...
    <form action="#" method="post" id="add_forum_board_form">
        ...
        <input type="hidden" name="board_id" value="<?php echo $board->ID_BOARD ?>" />

		<div class="mt5">
			<label for="boardName" class="cp"><?php echo $this->__('Board name');?></label>
			<div class="border mt2">
				<input name="board_name" class="w576 news_border board_name" id="boardName" value="<?php echo $board->BoardName; ?>" />
			</div>
		</div>
