<div class="message_container">
    ...
    <!-- end header -->
    <form action="#" method="post" id="adddownload_game_form">
        ...
        <a href="javascript:void(0);" class="link_green fr adddownload_game"><span><span><?php echo $this->__('Save'); ?></span></span></a>
    </form>
</div>
