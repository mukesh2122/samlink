<div class="message_container">
    ...
    <form action="#" method="post" id="edit_game_form">
		...
		<div class="mt5">
			...
			<div class="border mt2">
				<textarea name="game_description" rows="5" class="news_border w576" id="gameDescription"><?php echo $this->__($game->GameDesc); ?></textarea>
			</div>
		</div>
        ...
        <a href="javascript:void(0);" class="link_green fr update_game_info"><span><span><?php echo $this->__('Save'); ?></span></span></a>
    </form>
</div>
