<?php if(isset($companyMedia) and !empty($companyMedia)):?>
	<table cellspacing="0" cellpadding="0" class="table table_bordered table_striped gradient_thead mt10">
		...
		<tbody>
			...
			<?php foreach($companyMedia as $key => $item):?>
				<tr>
					...
					<td class="size_10 centered">
                                            ...
                                            <a href="<?php echo MainHelper::site_url('admin/companies/edit/'.$item->ID_OWNER.'/media/edit/'.$item->ID_MEDIA);?>"><?php echo $this->__('Edit');?></a>
                                            <?php endif; ?>
                                        </td>
					<td class="size_10 centered">
                                            <a href="<?php echo MainHelper::site_url('admin/companies/edit/'.$item->ID_OWNER.'/media/delete/'.$item->ID_MEDIA);?>"><?php echo $this->__('Delete');?></a>
					</td>
				</tr>
			<?php endforeach;?>
		</tbody>
