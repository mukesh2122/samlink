<?php if(isset($companyDownloadTabs) and !empty($companyDownloadTabs)):?>
	<table cellspacing="0" cellpadding="0" class="table table_bordered table_striped gradient_thead mt10">
		...
		<tbody>
			...
			<?php foreach($companyDownloadTabs as $key => $item):?>
				<tr>
					...
					<td class="size_10 centered">
                                            <a href="<?php echo MainHelper::site_url('admin/companies/edit/'.$item->ID_OWNER.'/downloadtabs/edit/'.$item->ID_FILETYPE);?>"><?php echo $this->__('Edit');?></a>
                                        </td>
					<td class="size_10 centered">
                                            <a href="<?php echo MainHelper::site_url('admin/companies/edit/'.$item->ID_OWNER.'/downloadtabs/delete/'.$item->ID_FILETYPE);?>"><?php echo $this->__('Delete');?></a>
					</td>
				</tr>
			<?php endforeach;?>
		</tbody>
