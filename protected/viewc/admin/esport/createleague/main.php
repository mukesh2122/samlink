...
<div id="container" class="clearfix">
	...
	<div id="esports_wrapper">
		...
		<div class="esports_content">
			...
			<?php echo $this->renderBlock('admin/esport/createleague/rightcolumn', array('profile'=>$profile,'edit_action' => $edit_action,'ID_LEAGUE' => $ID_LEAGUE, 'leagueData' => $leagueData)); ?>
		</div>
