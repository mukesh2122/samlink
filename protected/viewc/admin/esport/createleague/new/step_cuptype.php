<div class="mt10">
	<h3><a><?php echo $this->__('Cup Type'); ?></a></h3>
	<div class="ct_page_area">
		<form id="SingleElimForm" class="team_size_form" action="<?php echo MainHelper::site_url('esport/admin/createcup/1');?>" method="post">
			...
			<div>	
				<button type="submit" class="button_medium green rounded_5 ct_btn ct_cupfix mt20" style="width:150px"><?php echo $this->__('Single Elimination'); ?></button>
				<div class="mt15">
					<p><?php echo $this->__('Teams are first arranged into groups where each team plays against each other team. <br />
		...
		<form id="DoubleElimForm" class="team_size_form" action="<?php echo MainHelper::site_url('esport/admin/createcup/1');?>" method="post">
			...
			<div>	
				<div class="mt15">
					<button type="submit" class="button_medium light_blue rounded_5 ct_btn ct_cupfix mt20" style="width:150px"><?php echo $this->__('Double Elimination'); ?></button>
				</div>
				<div class="mt15">
					<p>
