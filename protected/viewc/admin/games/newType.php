<form class="standard_form" method="post" action="">
	...
	<div class="standard_form_header clearfix">
		<h1 class="pull_left"><?php echo $this->__('Create new game type'); ?></h1>
	</div>
	...
	<div class="standard_form_elements clearfix">
            <div class="clearfix">
                ...
                <span>
                    <input tabindex="1" id="GameTypeName" name="GameTypeName" type="text" value="" class="text_input" />
                </span>
            </div>
            <div class="clearfix">
                ...
                <span>
                    <div class="standard_form_checks_wrapper no-margin clearfix">
                        <textarea rows="7" cols="43" tabindex="2" id="GameTypeDesc" name="GameTypeDesc"></textarea>
                    </div>
                </span>
            </div>
