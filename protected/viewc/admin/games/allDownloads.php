<?php if(isset($gameDownloads) and !empty($gameDownloads)):?>
	<table cellspacing="0" cellpadding="0" class="table table_bordered table_striped gradient_thead mt10">
		...
		<tbody>
			...
			<?php foreach($gameDownloads as $key => $item):?>
				<tr>
					...
					<td class="size_10 centered">
                                            <a href="<?php echo MainHelper::site_url('admin/games/edit/'.$item->ID_OWNER.'/downloads/edit/'.$item->ID_DOWNLOAD);?>"><?php echo $this->__('Edit');?></a>
                                        </td>
					<td class="size_10 centered">
                                            <a href="<?php echo MainHelper::site_url('admin/games/edit/'.$item->ID_OWNER.'/downloads/delete/'.$item->ID_DOWNLOAD);?>"><?php echo $this->__('Delete');?></a>
					</td>
				</tr>
			<?php endforeach;?>
		</tbody>
