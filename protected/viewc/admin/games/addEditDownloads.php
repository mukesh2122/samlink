...
if(count($gameDownloadTabs)==0) {
    $gameDownloadTabs[] = (object) array(
                'ID_FILETYPE' => 0,
...
$EditorData = array(
        ...
        'Elements'      => array(
            ...
            array(
                ...
                'id'        => 'tab_id',
                'type'      => 'select',
                'options'   => ContentHelper::ObjArrayToOptions($gameDownloadTabs, 'ID_FILETYPE', 'FiletypeName', 'ID_FILETYPE', array((isset($filetype)?$filetype:null)))
            ),
            array(
