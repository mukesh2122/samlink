...
<div class="news_article_actions_container clearfix">
	...
	<div class="news_article_actions">
		...
		if(Auth::isUserLogged()):
            ...
            if($item->isDisliked()): ?>
				<a data-opt='{"id":"<?php echo $itemID; ?>", "reply": "0", "type":"news", "like":"0"}' class="icon_link action_undislike undislike_<?php echo $itemID; ?>_0" href="javascript:void(0);">
                    <i class="dislike_icon"></i>
                    <?php echo $undislikeTxt; ?> 
            ...
            <?php endif;
			if(($functions['subscribe'] == 1) && ($isApproved == 1)):
                if($item->isSubscribed()): ?>
                    <a data-opt='{"id":"<?php echo $itemID; ?>", "type":"<?php echo SUBSCRIPTION_NEWS; ?>"}' class="icon_link dn subscribe subscribe_<?php echo $itemID; ?>" href="javascript:void(0);">
                        <i class="subscribe_icon"></i>
                        <?php echo $subscribeTxt; ?>
                    </a>
                    <a data-opt='{"id":"<?php echo $itemID; ?>", "type":"<?php echo SUBSCRIPTION_NEWS; ?>"}' class="icon_link unsubscribe unsubscribe_<?php echo $itemID; ?>" href="javascript:void(0);">
                        <i class="unsubscribe_icon"></i>
                        <?php echo $unsubscribeTxt; ?>
                    </a>
                <?php else: ?>
		...
		if(($functions['share'] == 1) && !$noProfileFunctionality): ?>
	...
	<?php if(($functions['comments'] == 1) && ($isApproved == 1)): ?>
        <!-- Comments start -->
        <div class="clearfix comment_container">
                    ...
                    <div class="comments-cont">
                        <div class="comments-top">
                            <div class="comments-bot pr">
                                <textarea id="comment_<?php echo $itemID; ?>" rows="1" class="ta comment_block" cols="1" title="<?php echo $commentTxt, '...'; ?>">
                                    <?php echo $commentTxt,'...'; ?>
                                </textarea>
                                <a data-opt='{"ID":"<?php echo $itemID; ?>", "langID": "<?php echo $langID; ?>"}' class="pa comment_newspost fft link_comment" href="javascript:void(0);">
                                    <?php echo $commentTxt; ?>
                                </a>
                            </div>
                        </div>
