<div class="mt5 pb5 dot_bot">
    ...
    <div class="searchGroupInputMid">
        <input type="text" id="" class="friendSearchBox fl w300 pl5 bareInput withLabel pt2" title="<?php echo $this->__('Search...'); ?>" value="<?php echo $this->__('Search...'); ?>" />
                ...
                <?php foreach($friends as $f): ?>
                    ...
                    <tr>
                        <td class="w10 dot_bot pt5 pb5">
                            <input id="playerInvite" value="<?php echo $item->ID_PLAYER; ?>" name="invitation[]" class="cp" type="checkbox"/>
                        </td>
...
<a id="" class="buttonRRound eventsSearchRound inviteFriendsSend fr mr4 mt10" href="javascript:void(0)" rel="<?php echo $event->ID_EVENT; ?>">
	<span class="lrc"></span>
	<span class="mrc">
		<span class="fl fs11"><strong><?php echo $this->__('Invite'); ?></strong></span>
	</span>
	<span class="rrc"></span>
</a>