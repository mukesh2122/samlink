    ...
    <div class="comments-cont mt10">
        <div class="comments-top">
              <div class="comments-bot clearfix pr">
                ...
                <span class="fl db"><input name="tags" class="dn" id="tags" value="<?php echo isset($friend) ? $friend->FirstName : ''; ?>" /></span>
              </div>
        </div>
    </div>
    ...
    <div class="comments-cont mt10">
        <div class="comments-top">
              <div class="comments-bot pr">
                ...
                <a class="pa message_post fft link_blue" href="javascript:void(0);"><span><span><?php echo $this->__('Send'); ?></span></span></a>
              </div>
        </div>
    </div>
</div>