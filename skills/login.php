...
<?php
if (isset($super)){
if(isset($_SESSION["logetin"])){ // den her spørger om vi har en session der er aktiv der hedder $_SESSION["logetin"] og hvis vi har det kan vi se nedenstående 
	
					
						 ?>
						 <!-- de næste 4 linier er en form med en logud knap --><h3></h3>
...
else{ // else her spørg om hvad den skal gøre hvis vi ikke har en aktiv $_SESSION["logetin"]
if(isset($_POST["login"])) // den her spørger om der er trykket på den knap der har navnet login som er vores login knap 
 {
				...
				// den sql der er på linie 48 går ud og tæller hvor mange gange brugeren findes i databasen 
