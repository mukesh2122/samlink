...
class DooConfig{
     ...
     *   "db" => <number>
     * ]
     * @link https://github.com/vert-x/mod-redis/
     * @var array
     * @since 2.0
     */
    ...
    /**
     * Path to the location to serve static files such as images, css, and html. eg. /var/www/html/
     * @var string
     * @since 2.0
     */
