...
class DooValidator {
    ...
    /**
     * Validate Alpha numeric values with space.
     *
     * Input string can only consist of only Letters or Digits.
     *
     * @param string $value Value of data to be validated
    ...
    */
    ...
    /**
     * Validate if values of an array string is in a list of values
     *
     * @param string $value Values of data to be validated in JSON array format
     * @param array $valueList List of values to be checked
     * @param string $msg Custom error message
     * @return string
     */
    ...
    /**
     * Validate is string value can be split by a delimiter. Default delimiter is a comma
     * @param $value
     * @param $delimiter
     * @param $field
     * @param null $msg
    ...
    /**
     * Validate is string value can be split by a delimiter with a maximum length of N. Default delimiter is a comma
     * @param $value
     * @param $delimiter
     * @param $field
     * @param null $msg
    ...
    /**
     * Validate if values of an array seperated by delimiter(Default comma) is in a list of values
     *
     * @param string $value Values of data to be validated in JSON array format
     * @param array $valueList List of values to be checked
     * @param string $msg Custom error message
