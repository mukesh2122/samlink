...
/* CHANGED BY AskeFC using prop instead of attr */
          (i === 0 && $option.prop('selected') !== undefined && $option.attr('disabled') !== undefined)?
          oTemplate = null
          :
...
/* COMMENTED BY AskeFC - since it breaks many of our select dropdowns */
  // Help prevent flashes of unstyled content
//  if (!ie6) { document.documentElement.className = document.documentElement.className + ' dk_fouc'; };
